"""
Pydantic v2 schemas and data definitions for Immunosuppression Trough Agent.
...
class AgentAlert(BaseModel):
    ...
    standard_reference: str = "CPIC Level A / FDA Guidance / ISMP Safety Standards"
    timestamp: str = Field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
...
class ConsensusDossier(BaseModel):
    dossier_id: str
    system_slug: str = "immunosuppression-trough-agent"
    domain: str = "Clinical Pharmacology & Pharmacogenomics"
    task_id: str
