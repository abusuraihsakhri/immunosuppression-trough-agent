"""
Command-Line Interface for TransplantTDM Sentinel: Tacrolimus, Cyclosporine & Everolimus Trough Agent.
"""
import argparse
import csv
import json
...
from .agents import TransplantTDMCoordinator
...
def main(argv=None):
    ...
    if args.command == "audit":
        ...
        print(f"  Domain: Transplant Medicine | Standard: ISHLT / AST Immunosuppression TDM Standards")
