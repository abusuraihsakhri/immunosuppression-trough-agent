"""
Command Line Interface for Immunosuppression Trough Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="immunosuppression-trough-agent", description="Immunosuppression Trough Agent")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Immunosuppression Trough Agent Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Immunosuppression Trough Agent API server on http://{args.host}:{args.port}")
